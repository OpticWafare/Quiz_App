...
public class NotificationSender {
	...
	private final static String API_URL = "https://fcm.googleapis.com/v1/projects/quizapp-ff98f/messages:send"; // TODO
	 ...
	 * @throws Exception
	 */
	public static void sendNotification(String fcmtoken, String title, String message) throws Exception {
	...
	private static String getAuthFile() {
		...
		InputStream in = NotificationSender.class.getResourceAsStream("/model/authorization.json"); // TODO
		String content = "";
